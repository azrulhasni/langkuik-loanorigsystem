import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-PSKK5FI5.js";
import "./chunk-CEYEUC5P.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-45ABHPMK.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-MI443INA.js");
