import "./chunk-ORIQ7UE3.js";
import {
  IronResizableBehavior
} from "./chunk-4RXROKUF.js";
import {
  IronA11yKeysBehavior
} from "./chunk-UXQVNIXW.js";
import "./chunk-KKNQZGBY.js";

// node_modules/@cwmr/paper-fab-speed-dial/paper-fab-speed-dial.js
...
var template = html`<iron-iconset-svg name="icons" size="24">
<svg><defs>
...
// node_modules/@cwmr/paper-fab-speed-dial/paper-fab-speed-dial-overlay.js
import "@polymer/polymer/polymer-legacy.js";
...
var verticalScrollbarMaxWidthBugOffset = void 0;
var getVerticalScrollbarMaxWidthBugOffset = () => {
...
// node_modules/@polymer/iron-overlay-behavior/iron-overlay-behavior.js
import { dom as dom6 } from "@polymer/polymer/lib/legacy/polymer.dom.js";
...
var IronFocusablesHelperClass = class {
  ...
  _collectTabbableNodes(node, result) {
    ...
    if (element.localName === "content" || element.localName === "slot") {
      children = dom2(element).getDistributedNodes();
    } else {
      children = dom2(element.root || element).children;
    }
...
`,
  ...
  prepare: function() {
    if (this.opened && !this.parentNode) {
      dom3(document.body).appendChild(this);
    }
  },
  open: function() {
    this.opened = true;
  ...
  complete: function() {
    if (!this.opened && this.parentNode === document.body) {
      dom3(this.parentNode).removeChild(this);
    }
  },
...
var IronOverlayManagerClass = class {
  constructor() {
    this._overlays = [];
    this._minimumZ = 101;
  ...
  get deepActiveElement() {
    ...
    while (active.root && dom4(active.root).activeElement) {
      active = dom4(active.root).activeElement;
    }
    return active;
  }
...
import "@polymer/polymer/polymer-legacy.js";
import { dom as dom5 } from "@polymer/polymer/lib/legacy/polymer.dom.js";
...
function _shouldPreventScrolling(event) {
  var target = dom5(event).rootTarget;
  if (event.type !== "touchmove" && lastRootTarget !== target) {
    lastRootTarget = target;
    lastScrollableNodes = _getScrollableNodes(dom5(event).path);
  }
...
var IronOverlayBehaviorImpl = {
  ...
  get _focusNode() {
    return this._focusedChild || dom6(this).querySelector("[autofocus]") || this;
  },
  get _focusableNodes() {
  ...
  attached: function() {
    ...
    this._observer = dom6(this).observeNodes(this._onNodesChange);
  },
  detached: function() {
    if (this._observer) {
      dom6(this).unobserveNodes(this._observer);
    }
    this._observer = null;
  ...
  __onCaptureScroll: function(event) {
    ...
    if (dom6(event).path.indexOf(this) >= 0) {
      return;
    }
...
var composedParent = (node) => node.assignedSlot || node.parentNode || node.host;
var composedContains = (ancestor, descendant) => {
...
// node_modules/@cwmr/paper-fab-speed-dial/paper-fab-speed-dial.js
import { Polymer as Polymer3 } from "@polymer/polymer/lib/legacy/polymer-fn.js";
...
found at http://polymer.github.io/PATENTS.txt
*/
//# sourceMappingURL=@cwmr_paper-fab-speed-dial_paper-fab-speed-dial__js.js.map
