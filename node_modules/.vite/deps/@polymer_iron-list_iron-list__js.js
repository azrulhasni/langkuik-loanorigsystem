...
`,
  ...
  get _itemsParent() {
    return dom2(dom2(this._userTemplate).parentNode);
  },
  get _maxScrollTop() {
  ...
  _focusPhysicalItem: function(idx) {
    ...
    if (!focusable) {
      focusable = dom2(physicalItem).querySelector('[tabindex="' + SECRET_TABINDEX + '"]');
    }
    model.tabIndex = 0;
  ...
  _getActiveElement: function() {
    ...
    return dom2(itemsHost ? itemsHost.root : document).activeElement;
  }
});
/**
@license
